...
#define PM_PRINTMSG         (PM_BASE + 48)
#define PM_PSEM_INIT        (PM_BASE + 49)
#define PM_PSEM_WAIT        (PM_BASE + 50)
#define PM_PSEM_SIGNAL      (PM_BASE + 51)
#define PM_PSEM_DESTROY     (PM_BASE + 52)
#define PM_PSEM_NO          (PM_BASE + 53)
#define PM_PSEM_BLOCK       (PM_BASE + 54)
#define PM_PSEM_WAKEUP      (PM_BASE + 55)
